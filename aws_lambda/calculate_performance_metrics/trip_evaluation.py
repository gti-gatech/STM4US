...
from intersection_deviations import IntersectionDeviations
...
def calculate_deviations(env, monitoredTrip, trackedJourney, query_url):
    ...
    for leg in legs:
        ...
        if leg["mode"] == "WALK":
            ...
            while not legFinished:
                ...
                if minDist > MINDIST:
                    ...
                    if onTrack:
                        ...
                        deviatedLink = leg["steps"][min_leg_past]
                        deviatedLinks.append(deviatedLink["streetName"])

                        print("Deviation Found, checking if it occurs at an intersection")

                        # determine if the deviated link occurs at a traffic light intersection
                        deviated_lat = deviatedLink["lat"]
                        deviated_lon = deviatedLink["lon"]
                        inbox = IntersectionDeviations.find_intersection_deviations_class(env, deviated_lat, deviated_lon, query_url)

                        if inbox:
                            print("User deviation found at a traffic light intersection at lat/lon:", 
                                  deviated_lat, deviated_lon)
                            numIntersectionDeviations += 1
            ...
            print("Unknown mode of transport: ", leg["mode"])
    ...
    return {"deviatedLinks": deviatedLinks, "timestampsDeviated": timestampsDeviated, 
            "numDeviations": numDeviations, "numIntersectionDeviations": numIntersectionDeviations,
            "completed": completed, "fixedTransit": fixedTransit}
